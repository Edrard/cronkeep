...
class MailForm extends Form implements InputFilterProviderInterface
{
    ...
    */
    public function __construct()
    {
        ...
        // Command line
        $command = new Element\Text('path');
        $command->setLabel('Script Path');
        $command->setAttributes(array(
            'autocomplete' => 'off',
            'class' => 'form-control',
            'value' => getcwd().'/mail.php'
        ));
        $this->add($command);

        // From
        $command = new Element\Text('from');
        $command->setLabel('From');
        $command->setAttributes(array(
            'autocomplete' => 'off',
            'class' => 'form-control'
        ));
        ...
        // Subject
        $command = new Element\Text('subject');
        $command->setLabel('Subject');
        $command->setAttributes(array(
            'autocomplete' => 'off',
            'class' => 'form-control'
        ));
